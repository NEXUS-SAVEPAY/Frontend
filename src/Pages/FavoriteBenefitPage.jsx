...
import { getUserFavoriteBrands, addFavoriteBrandByName, removeFavoriteBrandById } from '../services/api/interestbrandApi';
...
const FavoriteBenefitPage = () => {
  ...
  // 서버 데이터
  const [favBrands, setFavBrands] = useState([]); // 관심 브랜드 [{id, name, image}]
  const [groups, setGroups] = useState([]);       // 혜택 [{ brand, brandImage, benefits:[...] }]
