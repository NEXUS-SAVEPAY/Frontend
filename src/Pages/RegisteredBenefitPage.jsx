...
function RegisteredBenefitPage() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const { card, pay, telco, unknown } = await fetchRegisteredPaymentTop2();
        setCardTop2(card ?? []);
        setPayTop2(pay ?? []);
        setTelcoTop2(telco ?? []);
        setUnknown(unknown ?? []); // 분류 불가 항목 (보여주지 않아도 됨)
      } catch (e) {
        ...
        <>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.benefitList}>
              ...
              {cardTop2.length === 0 && <p className={styles.emptyText}>표시할 카드 혜택이 없습니다.</p>}
            </div>
          </section>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.benefitList}>
              ...
              {payTop2.length === 0 && <p className={styles.emptyText}>표시할 간편결제 혜택이 없습니다.</p>}
            </div>
          </section>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.benefitList}>
              ...
              {telcoTop2.length === 0 && <p className={styles.emptyText}>표시할 통신사 혜택이 없습니다.</p>}
            </div>
          </section>
        </>
      )}
